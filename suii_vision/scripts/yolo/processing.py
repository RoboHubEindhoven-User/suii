...
class PostProcessing:
    ...
    def __init__(self):
        ...
        data = np.load('/home/ros/catkin_ws/src/suii/suii_vision/scripts/camera_calibration/mtx.npz')
        self.mtx = data['mtx']
        data = np.load('/home/ros/catkin_ws/src/suii/suii_vision/scripts/camera_calibration/dist.npz')
        self.dist = data['dist'] 
